...
model = load_model(r'C:\Users\yudhika wira utama\Downloads\Tugas6_B_11701\model_mobilenet.h5')
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga 1701")  # 4 digit npm terakhir
